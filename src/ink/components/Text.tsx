...
type LegacyColor = Color | 'black' | 'red' | 'green' | 'yellow' | 'blue' | 'magenta' | 'cyan' | 'white'
...
type BaseProps = {
   ...
   */
  readonly backgroundColor?: LegacyColor
...
export default function Text({
  ...
  const textStyles: TextStyles = {
    ...
    ...(backgroundColor && { backgroundColor: normalizeColor(backgroundColor) }),
...
function normalizeColor(color: LegacyColor): Color {
  if (color.includes(':') || color.startsWith('#') || color.startsWith('rgb(') || color.startsWith('ansi256(')) {
