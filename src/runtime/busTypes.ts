...
export type BusEvent =
  | { type: "bus_routing_started"; session_id: string; workflow_id: string; phase: "user" | "plan" | "lifecycle" }
  | { type: "bus_directive_selected"; session_id: string; workflow_id: string; directive: DispatchDirective }
  ...
  | { type: "bus_dispatcher_retry_scheduled"; session_id: string; workflow_id: string; retry_attempt: number; max_retries: number; retry_in_ms: number; error: string }
